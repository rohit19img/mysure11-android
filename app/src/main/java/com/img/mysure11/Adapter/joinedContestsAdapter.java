...
public class joinedContestsAdapter extends RecyclerView.Adapter<joinedContestsAdapter.MyViewHolder>{
    ...
    public joinedContestsAdapter(Context context, ArrayList<contestGetSet> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder,final int i) {
        ...
        if(list.get(i).getPrice_card().size() == 0){
            holder.prize1.setText("₹ "+nf2.format(list.get(i).getWinamount())+"");
        } else
        ...
        if(list.get(i).getMulti_entry() == 1)
            holder.totalEntries.setText("Upto "+gv.getMax_teams()+" Entries");
        else
        ...
        holder.btnJoin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(list.get(i).isIsselected()){
                    ...
                    MyTeams(i,list.get(i).getChallenge_id());
                }
            }
        });
                ...
                if(response.code() == 200) {
                    ...
                    if(result == 0){
                        if(gv.getSportType().equals("Cricket")) {
                            ...
                            ii.putExtra("challengeId", list.get(pos).getChallenge_id());
                        ...
                        intent.putExtra("challenge_id", list.get(pos).getChallenge_id());
                        ...
                        intent.putExtra("challengeId", list.get(pos).getChallenge_id());
                        context.startActivity(intent);
                        gv.setMulti_entry(String.valueOf(list.get(pos).getMulti_entry()));
                    }
