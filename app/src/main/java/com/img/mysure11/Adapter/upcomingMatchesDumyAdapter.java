...
public class upcomingMatchesDumyAdapter extends RecyclerView.Adapter<upcomingMatchesDumyAdapter.MyViewHolder>{
    ...
    public upcomingMatchesDumyAdapter(Context context, ArrayList<upcomingMatchesGetSet> list, String type) {
