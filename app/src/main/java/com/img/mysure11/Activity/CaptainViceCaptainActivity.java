...
public class CaptainViceCaptainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.wallet).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CaptainViceCaptainActivity.this,WalletActivity.class));
            }
        });
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(viceCaptain_id.equals("")  || captain_id.equals("") || captain_id.equals(viceCaptain_id)) {
                    new AppUtils().showError(CaptainViceCaptainActivity.this,"Please select captain & vice-captain");
                }else{
                        ...
                        public void onResponse(String response)
                        {
                            try {
                                ...
                                if(jsonObject.getBoolean("success")){
                                    if(challengeId !=0){
                                        new AppUtils().showError(CaptainViceCaptainActivity.this,jsonObject.getString("msg"));
                    ...
                    new com.android.volley.Response.ErrorListener()
                    {
                        ...
                        public void onErrorResponse(VolleyError error)
                        {
                            ...
                            if (networkResponse != null && networkResponse.statusCode == HttpStatus.SC_UNAUTHORIZED) {
                                ...
                                new AppUtils().Toast(CaptainViceCaptainActivity.this,"Session Timeout");
