...
public class TeamPreviewFootballActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_preview_football);
    ...
    public void Player(LinearLayout ll, final ArrayList<captainListGetSet> list){
        ...
        for (int f = 0 ;f < list.size();f++){
            ...
            Picasso.with(TeamPreviewFootballActivity.this).load(list.get(f).getImage()).placeholder(R.drawable.avtar).into(image);
