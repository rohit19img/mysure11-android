...
import com.img.mysure11.Fragment.PlayersFootballFragment;
...
public class CreateTeamFootballActivity extends AppCompatActivity {
    ...
    int tab_icons[] = {R.drawable.ic_gk_icons,R.drawable.ic_defender_icon,R.drawable.ic_mf_icon,R.drawable.ic_striker_icon};
    int tab_icons_selected[] = {R.drawable.ic_gk_selected,R.drawable.ic_defender_selected,R.drawable.ic_mf_selected,R.drawable.ic_striker_selected};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(teamNumber > gv.getMax_teams()){
            new AppUtils().showError(CreateTeamFootballActivity.this,"Can't create more teams");
            finish();
        }
        ...
        Picasso.with(CreateTeamFootballActivity.this).load(gv.getTeam1Image()).into(team1Image);
        Picasso.with(CreateTeamFootballActivity.this).load(gv.getTeam2image()).into(team2Image);
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Clist.size() != 11){
                    new AppUtils().showError(CreateTeamFootballActivity.this,"Complete your team first");
                }else{
                    String option;
                    if(edit)
                        option="Edit";
                    ...
                    Intent ii= new Intent(CreateTeamFootballActivity.this,CaptainViceCaptainFootballActivity.class);
        ...
        btnPreview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent ii= new Intent(CreateTeamFootballActivity.this, TeamPreviewFootballActivity.class);
    ...
    public class SectionPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new PlayersFootballFragment(list,listWK,"Select 1 Goal-Keeper",edit);
                case 1:
                    return new PlayersFootballFragment(list,listBAT,"Select 3-5 Defender",edit);
                case 2:
                    return new PlayersFootballFragment(list,listBOWL,"Select 3-5 Mid-Fielder",edit);
                default:
                    return new PlayersFootballFragment(list,listAR,"Select 1-3 Forward",edit);
        ...
        call.enqueue(new Callback<ArrayList<PlayerListGetSet>>() {
            ...
            public void onResponse(Call<ArrayList<PlayerListGetSet>> call, Response<ArrayList<PlayerListGetSet>> response) {
                ...
                if(response.code() == 200) {
                    ...
                    vp.setAdapter(new CreateTeamFootballActivity.SectionPagerAdapter(getSupportFragmentManager()));
                    ...
                    new AppUtils().Toast(CreateTeamFootballActivity.this,"session Timeout");
                    ...
                    android.app.AlertDialog.Builder d = new android.app.AlertDialog.Builder(CreateTeamFootballActivity.this);
