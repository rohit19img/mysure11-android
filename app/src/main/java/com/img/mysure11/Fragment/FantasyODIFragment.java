...
public class FantasyODIFragment extends Fragment {
    ...
    String [] type = {"Run","Boundary Bonus","Six Bonus","Half-century Bonus","Century Bonus","Dismissal for a duck"
            ...
            ,"Below 2.5 runs per over","Between 2.5 - 3.49 runs per over","Between 3.5 - 4.5 runs per over","Between 7 - 8 runs per over","Between 8.1 - 9 runs per over","Above 9 runs per over"
            ,"Between 50 - 60 runs per 100 balls","Between 40 - 49.99 runs per 100 balls","Below 40 runs per 100 balls"};
