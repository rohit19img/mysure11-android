...
public class PlayersFragment extends Fragment {
    ...
    public PlayersFragment(ArrayList<PlayerListGetSet> list1, ArrayList<PlayerListGetSet> list, String Text, boolean edit){
        this.list = list;
        this.list1 = list1;
        this.Text = Text;
        this.edit = edit;
...
//        creditsIcon.setText(Html.fromHtml("&#x2191;"));
        ...
        playersList.setAdapter(new PlayerListAdapter(context,list,list1,edit));
