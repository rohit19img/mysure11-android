 ...
 */
public class FantasyT20Fragment extends Fragment {
    ...
    String [] points = {"+1","+1","+2","+8","+16","-2"
            ...
            ,"+6","+4","+2","-2","-4","-6"
            ,"-2","-4","-6"};
    String [] type = {"Run","Boundary Bonus","Six Bonus","Half-century Bonus","Century Bonus","Dismissal for a duck"
            ,"Wicket","4 Wicket haul Bonus","5 Wicket haul Bonus","Maiden Over"
            ,"Catch","Stumping/Run-out","Run Out(Thrower)", "Run Out(Catcher)"
            ,"Captain","Vice-Captain","In Starting 11"
            ,"Below 4 runs per over","Between 4 - 4.99 runs per over","Between 5 - 6 runs per over","Between 9 - 10 runs per over","Between 10.1 - 11 runs per over","Above 11 runs per over"
            ,"Between 60 - 70 runs per 100 balls","Between 50 - 59.9 runs per 100 balls","Below 50 runs per 100 balls"};
    ...
    String groupSubTitle[]={"","","","","Min 2 Overs to be Bowled","Min 10 Balls to be Played"};
