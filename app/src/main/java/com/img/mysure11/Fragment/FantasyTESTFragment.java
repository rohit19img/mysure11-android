 ...
 */
public class FantasyTESTFragment extends Fragment {
    ...
    String groupAr[]= {"Batting","Bowling","Fielding","Others"};
    String groupSubTitle[]={"","","",""};
    int icons[] = {R.drawable.mw11_bat, R.drawable.mw11_ball,R.drawable.mw11_fielding,R.drawable.mw11_others};

    public FantasyTESTFragment() {
